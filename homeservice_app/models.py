...
class seed(models.Model):
    seeed=models.ForeignKey(Login,on_delete=models.CASCADE,null=True)
...
class plant(models.Model):
    plaant=models.ForeignKey(Login,on_delete=models.CASCADE,null=True)
    name=models.CharField(max_length=20)
...
class fertilizer(models.Model):
    fert=models.ForeignKey(Login,on_delete=models.CASCADE,null=True)
    name=models.CharField(max_length=20)
